...
var ApplicationConfiguration = (function() {
	...
	var applicationModuleName = 'Denis Lysenko';
	var applicationModuleVendorDependencies = ['ngResource', 'ui.router', 'ui.bootstrap', 'ui.utils', 'ngFileUpload', 'ngSanitize'];
...
angular.module('admin').controller('MainAdminController', ['$location', 'CheckAuth', function($location, CheckAuth) {
